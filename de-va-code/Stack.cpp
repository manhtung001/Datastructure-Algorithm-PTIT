...
??O T?
Bài làm t?t nh?t
Cho xâu ký t? S. Nhi?m v? c?a b?n là ??o ng??c các t? trong S. Ví d? S =  “I like this program very much”, ta nh?n ???c k?t qu? là “much very program this like I”.
Input:
?	Dòng ??u tiên ??a vào s? l??ng b? test T.
?	Nh?ng dòng k? ti?p ??a vào T b? test. M?i b? test là m?t xâu ký t? S.
?	T, S th?a mãn ràng bu?c: 1? T ?100; 1? Length(S)?103.
Output:
?	??a ra k?t qu? m?i test theo t?ng dòng.
Ví d?:
Input:	Output:
